...
app.get("/", (req, res) => {
	...
	let iphoneSrc = process.env.AWS_URL + catalog + "/" + product + ".usdz";
	let androidSrc = process.env.AWS_URL + catalog + "/" + product + ".glb";
	...
	let colorArray = [req.query.color1, req.query.color2, req.query.color3, req.query.color4];
	let sizeArray = [
		req.query.size1,
		req.query.size2,
		req.query.size3,
